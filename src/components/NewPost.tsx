  ...
  return (
    <form className='w-full text-center'>
      ...
      <div className='block md:flex justify-between items-center'>
        <label htmlFor='title' className='md:w-1/12 text-left'>
          Title
        </label>
        <input
          id='title'
          type='text'
          className='w-[100%] md:w-11/12 h-10 border p-3 focus-within:outline-none focus-within:border-2'
          onChange={(e) =>
      ...
      <div className='md:flex justify-between items-center mt-2'>
        <label htmlFor='body' className='md:w-1/12 text-left'>
          Body
        </label>
        <textarea
          id='body'
          className='w-[100%] md:w-11/12 h-64 p-3 border focus-within:outline-none focus-within:border-2'
          onChange={(e) =>
